...
df = pd.read_csv("cov/dati-provincie/dati-province/dpc-covid19-ita-province-latest.csv", sep=',',
                 usecols=['lat', 'long', 'denominazione_provincia', 'totale_casi'])
df1 = pd.read_csv("cov/dati-provincie/dati-province/dpc-covid19-ita-province-latest.csv", sep=',',
...
dfg = pd.read_csv(
    "cov/dati-andamento-nazionale/dati-andamento-nazionale/dpc-covid19-ita-andamento-nazionale-latest.csv", sep=',')
...
fig1.update_layout(paper_bgcolor='#000000', title_text='National positive cases', xaxis_rangeslider_visible=True,
                   plot_bgcolor='#222222', titlefont=dict(color='white'), font=dict(color='#767677'),
...
fig2.update_layout(paper_bgcolor='#000000', title_text='National ospedalized', titlefont=dict(color='white'),
                   plot_bgcolor='#222222', xaxis_rangeslider_visible=True, font=dict(color='#767677'),
...
fig3.update_layout(paper_bgcolor='#000000', title_text='National deaths', titlefont=dict(color='white'),
                   plot_bgcolor='#222222', xaxis_rangeslider_visible=True, font=dict(color='#767677'),
                   yaxis=dict(showspikes=True, spikemode='toaxis', gridcolor='#665a73'),
                   xaxis=dict(showspikes=True, spikemode='toaxis', zerolinewidth=1, gridcolor='#665a73'))

fig4 = go.Figure(go.Scatter(x=d_df.data, y=d_df.nuovi_positivi, mode='lines', line_color='deepskyblue'))
fig4.update_layout(paper_bgcolor='#000000', title_text='New positive cases', titlefont=dict(color='white'),
                   plot_bgcolor='#222222', xaxis_rangeslider_visible=True, font=dict(color='#767677'),
                   yaxis=dict(showspikes=True, spikemode='toaxis', gridcolor='#665a73'),
                   xaxis=dict(showspikes=True, spikemode='toaxis', zerolinewidth=1, gridcolor='#665a73'))

fig5 = go.Figure(go.Scatter(x=d_df.data, y=d_df.dimessi_guariti, mode='lines', line_color='lightgreen'))
fig5.update_layout(paper_bgcolor='#000000', title_text='National survived', titlefont=dict(color='white'),
                   plot_bgcolor='#222222', xaxis_rangeslider_visible=True, font=dict(color='#767677'),
                   yaxis=dict(showspikes=True, spikemode='toaxis', gridcolor='#665a73'),
                   xaxis=dict(showspikes=True, spikemode='toaxis', zerolinewidth=1, gridcolor='#665a73'))

fig6 = go.Figure(go.Scatter(x=d_df.data, y=d_df.tamponi, mode='lines', line_color='red'))
fig6.update_layout(paper_bgcolor='#000000', title_text='National tampons', titlefont=dict(color='white'),
                   plot_bgcolor='#222222', xaxis_rangeslider_visible=True, font=dict(color='#767677'),
                   yaxis=dict(showspikes=True, spikemode='toaxis', gridcolor='#665a73'),
                   xaxis=dict(showspikes=True, spikemode='toaxis', zerolinewidth=1, gridcolor='#665a73'))
...
fig7.update_layout(paper_bgcolor='#000000', title_text='Provincial cases of ' + str(inp),
                   xaxis_rangeslider_visible=True, titlefont=dict(color='white'), plot_bgcolor='#222222',
...
tab1 = go.Figure(
    ...
    header=dict(values=list(['Area', 'Ospedalized', 'Survived', 'Deaths', 'New']),
                ...
                align='center'),
    cells=dict(
        values=[dfr['denominazione_regione'], dfr['totale_ospedalizzati'], dfr['dimessi_guariti'], dfr['deceduti'],
                dfr['nuovi_positivi']],
        font=dict(
            color='#767677'
        ),
...
server.layout = html.Div([
    ...
    dcc.Graph(figure=tab, id='tab', style={'height': '80vh'}),
    dcc.Graph(figure=tab1, id='tab1', style={'height': '40vh'}),
    dcc.Graph(figure=tab2, id='tab2', style={'height': '20vh'}),
